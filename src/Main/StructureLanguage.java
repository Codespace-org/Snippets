 ...
 */
public class StructureLanguage extends Section{
    ...
    public  Button[] displayButtons(TextArea ta){
        ...
        Button links = new Button("Linked List");                     //Create new button

        Button trees = new Button("Trees");

        Button[] btnGroup = {nodes,links,trees,save};           //Assign buttons to array
        ...
        nodes.setOnAction(e -> {                                         //set action
            final String dataFilename = "Nodes.txt";
            FileIO.run(finalTa, save, dataFilename);                             //Call run method for dataType section
        });

        links.setOnAction(e -> {
            final String operatorFilename = "Links.txt";
            FileIO.run(finalTa, save, operatorFilename);
        });

        trees.setOnAction(e -> {
            final String conditionsFilename = "Trees.txt";
    ...
    public BorderPane displayLanguageWindow(TextArea ta){
        ...
        leftBox.getChildren().add(new Label("Data Structures"));                //Label the VBox and display label
    ...
    public void run(){
        ...
        super.getTa().setText(new StructureLanguage().toString());
    ...
    public String toString(){
        return "This section contains more advanced structures\n" +
                "\n" +
                "This only a syntax guide for ADT Structures";
    }
}
